...
// Função para testar a execução de um arquivo Lox e capturar a saída
...
void test_funcionalidade_lox() {
    ...
    // Teste de erro para 'teste_erros.lox' (esperado erro)
...
int main() {
    // Inicializando o registro do CUnit
    CU_initialize_registry();
    
    // Adicionando a suíte de testes
